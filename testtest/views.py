...
class IndexView(ListView):
    template_name = 'testtest/index.html'
...
class IndexView_redirect(ListView):
    template_name = 'testtest/index.html'
    context_object_name = 'daily_list'
    model = daily
...
index_redirect = IndexView_redirect.as_view()
...
def add_daily_record(request):
    return render(request, 'testtest/add_daily_record.html')
...
def add_reminder_record(request):
    return render(request, 'testtest/add_reminder_record.html')
...
def add_objective_record(request):
    return render(request, 'testtest/add_objective_record.html')
